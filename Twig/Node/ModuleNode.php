...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use eLightUp\Twig\Environment;\n")
                ->write("use eLightUp\Twig\Error\LoaderError;\n")
                ->write("use eLightUp\Twig\Error\RuntimeError;\n")
                ->write("use eLightUp\Twig\Extension\CoreExtension;\n")
                ->write("use eLightUp\Twig\Extension\SandboxExtension;\n")
                ->write("use eLightUp\Twig\Markup;\n")
                ->write("use eLightUp\Twig\Sandbox\SecurityError;\n")
                ->write("use eLightUp\Twig\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use eLightUp\Twig\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use eLightUp\Twig\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use eLightUp\Twig\Source;\n")
                ->write("use eLightUp\Twig\Template;\n\n")
            ;
        }
        $compiler
