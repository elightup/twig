...
use eLightUp\Twig\Extension\GlobalsInterface;
use eLightUp\Twig\Extension\StagingExtension;
    ...
    private function initExtension(ExtensionInterface $extension): void
    {
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            if (!$parser instanceof TokenParserInterface) {
                throw new \LogicException('getTokenParsers() must return an array of \eLightUp\Twig\TokenParser\TokenParserInterface.');
            }
