...
use eLightUp\Twig\Node\Expression\ArrayExpression;
use eLightUp\Twig\Node\Expression\ArrowFunctionExpression;
use eLightUp\Twig\Node\Expression\AssignNameExpression;
use eLightUp\Twig\Node\Expression\Binary\ConcatBinary;
use eLightUp\Twig\Node\Expression\BlockReferenceExpression;
...
use eLightUp\Twig\Node\Expression\MethodCallExpression;
use eLightUp\Twig\Node\Expression\NameExpression;
use eLightUp\Twig\Node\Expression\ParentExpression;
...
class ExpressionParser
{
    ...
    private function getTestNodeClass(TwigTest $test): string
    {
        if ($test->isDeprecated()) {
            $stream = $this->parser->getStream();
            $message = sprintf('eLightUp\Twig Test "%s" is deprecated', $test->getName());
    ...
    private function getFunctionNodeClass(string $name, int $line): string
    {
        ...
        if ($function->isDeprecated()) {
            $message = sprintf('eLightUp\Twig Function "%s" is deprecated', $function->getName());
    ...
    private function getFilterNodeClass(string $name, int $line): string
    {
        ...
        if ($filter->isDeprecated()) {
            $message = sprintf('eLightUp\Twig Filter "%s" is deprecated', $filter->getName());
