 ...
 * instead, which returns an instance of \eLightUp\Twig\TemplateWrapper.
 *
...
abstract class Template
{
    ...
    public function displayBlock($name, array $context, array $blocks = [], $useBlocks = true, self $templateContext = null)
    {
        ...
        if (null !== $template && !$template instanceof self) {
            throw new \LogicException('A block must be a method on a \eLightUp\Twig\Template instance.');
        }
        ...
        if (null !== $template) {
            try {
                ...
                // this is mostly useful for \eLightUp\Twig\Error\LoaderError exceptions
                // see \eLightUp\Twig\Error\LoaderError
